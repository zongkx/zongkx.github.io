import{_ as i,C as l,o as a,c as t,a2 as n,b as o,w as e,a as c,E as r,a3 as h}from"./chunks/framework.CZW044RH.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"doc/blog/202607-AWS实战.md","filePath":"doc/blog/202607-AWS实战.md"}'),d={name:"doc/blog/202607-AWS实战.md"};function u(k,s,g,F,C,A){const p=l("Mermaid");return a(),t("div",null,[s[1]||(s[1]=n(`<h2 id="aws-cli-aksk" tabindex="-1">AWS CLI / AKSK <a class="header-anchor" href="#aws-cli-aksk" aria-label="Permalink to &quot;AWS CLI / AKSK&quot;">​</a></h2><p>AWS 网页端针对EKS/ECR等未提供网页版资源操作功能, 多数情况下都需要使用cli 和本地的kubectl 来操作资源, 所以需要先安装基础环境</p><ul><li>下载</li></ul><p><code>https://awscli.amazonaws.com/AWSCLIV2.msi</code></p><ul><li>AKSK</li></ul><p>AWS控制台进入: <code>IAM/安全性/创建访问密钥</code>, 创建一个 <code>AKSK</code>, IDEA插件可以直接配置<code>AKSK</code>使用.</p><ul><li>命令行登录</li></ul><p>命令行输入 <code>aws login</code> ,自动跳转浏览器登录即可</p><h2 id="ecr" tabindex="-1">ECR <a class="header-anchor" href="#ecr" aria-label="Permalink to &quot;ECR&quot;">​</a></h2><ol><li><p>创建存储库 <code>xxx/yyyy</code></p><p>页面创建后获取存储库 URI</p></li><li><p>push</p></li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@echo off</span></span>
...
<span class="line"><span>                  number: 443</span></span></code></pre></div><h2 id="cloudwatch" tabindex="-1">CloudWatch <a class="header-anchor" href="#cloudwatch" aria-label="Permalink to &quot;CloudWatch&quot;">​</a></h2><p>启用 Amazon EKS 的 CloudWatch Container Insights， 最推荐的方式是使用 Amazon CloudWatch Observability EKS 附加组件 (Add-on)</p><h3 id="第一步-配置-iam-权限" tabindex="-1">第一步：配置 IAM 权限 <a class="header-anchor" href="#第一步-配置-iam-权限" aria-label="Permalink to &quot;第一步：配置 IAM 权限&quot;">​</a></h3><p>直接附加到 Worker 节点 IAM 角色（较简单，权限较大） 将 CloudWatchAgentServerPolicy 托管策略附加到你的 EKS 工作节点所在的 IAM 角色</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>aws iam attach-role-policy \\</span></span>
<span class="line"><span>  --role-name YourWorkerNodeRoleName \\</span></span>
<span class="line"><span>  --policy-arn arn:aws:iam::aws:policy/CloudWatchAgentServerPolicy</span></span></code></pre></div><h3 id="第二步-安装-eks-附加组件" tabindex="-1">第二步：安装 EKS 附加组件 <a class="header-anchor" href="#第二步-安装-eks-附加组件" aria-label="Permalink to &quot;第二步：安装 EKS 附加组件&quot;">​</a></h3><p>在 AWS 控制台进入 Amazon EKS 服务。</p><p>选择你的集群，点击 “附加组件” 选项卡。</p><p>点击 “获取更多附加组件”，在列表中找到并选中 “Amazon CloudWatch Observability”。</p><p>点击 “下一步”，确认版本和 IAM 角色（可选择“从节点继承”或之前创建的 IRSA 角色），最后点击 “创建”。</p>`,68))])}const m=i(d,[["render",u]]);export{b as __pageData,m as default};
