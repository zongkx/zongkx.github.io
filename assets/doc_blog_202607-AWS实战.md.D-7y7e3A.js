import{_ as a,o as n,c as p,a2 as e}from"./chunks/framework.BHgser6W.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"doc/blog/202607-AWS实战.md","filePath":"doc/blog/202607-AWS实战.md"}'),i={name:"doc/blog/202607-AWS实战.md"};function l(t,s,o,c,h,r){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h2 id="aws-cli-aksk" tabindex="-1">AWS CLI / AKSK <a class="header-anchor" href="#aws-cli-aksk" aria-label="Permalink to &quot;AWS CLI / AKSK&quot;">​</a></h2><p>AWS 网页端针对EKS/ECR等未提供网页版资源操作功能, 多数情况下都需要使用cli 和本地的kubectl 来操作资源, 所以需要先安装基础环境</p><ul><li>下载</li></ul><p><code>https://awscli.amazonaws.com/AWSCLIV2.msi</code></p><ul><li>AKSK</li></ul><p>AWS控制台进入: <code>IAM/安全性/创建访问密钥</code>, 创建一个 <code>AKSK</code>, IDEA插件可以直接配置<code>AKSK</code>使用.</p><ul><li>命令行登录</li></ul><p>命令行输入 <code>aws login</code> ,自动跳转浏览器登录即可</p><h2 id="ecr" tabindex="-1">ECR <a class="header-anchor" href="#ecr" aria-label="Permalink to &quot;ECR&quot;">​</a></h2><ol><li><p>创建存储库 <code>xxx/yyyy</code></p><p>页面创建后获取存储库 URI</p></li><li><p>push</p></li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@echo off</span></span>
...
<span class="line"><span>set IMAGE_NAME=862087104231.dkr.ecr.us-east-1.amazonaws.com/aed/iwork-aed:%DOCKER_TAG%</span></span>
...
<span class="line"><span>echo ================================</span></span>
<span class="line"><span>endlocal</span></span></code></pre></div><h2 id="rds" tabindex="-1">RDS <a class="header-anchor" href="#rds" aria-label="Permalink to &quot;RDS&quot;">​</a></h2><h2 id="eks" tabindex="-1">EKS <a class="header-anchor" href="#eks" aria-label="Permalink to &quot;EKS&quot;">​</a></h2><h3 id="iam-policy" tabindex="-1">IAM Policy <a class="header-anchor" href="#iam-policy" aria-label="Permalink to &quot;IAM Policy&quot;">​</a></h3><p>使用ROOT账号给IAM账号赋权 <code>AmazonEKSAdminPolicy</code></p><h3 id="deployment" tabindex="-1">Deployment <a class="header-anchor" href="#deployment" aria-label="Permalink to &quot;Deployment&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>apiVersion: apps/v1</span></span>
...
<span class="line"><span>    alb.ingress.kubernetes.io/certificate-arn: arn:aws:acm:us-east-1:862087104231:certificate/********</span></span>
...
<span class="line"><span>    - host: aed-aws.comen.com</span></span>
...
<span class="line"><span>                  number: 443</span></span></code></pre></div>`,71)])])}const k=a(i,[["render",l]]);export{u as __pageData,k as default};
