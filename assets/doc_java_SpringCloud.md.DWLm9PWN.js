...
<span class="line"><span>                &lt;/exclusion&gt;</span></span>
<span class="line"><span>            &lt;/exclusions&gt;</span></span>
<span class="line"><span>        &lt;/dependency&gt;</span></span></code></pre></div><h4 id="provider" tabindex="-1">provider <a class="header-anchor" href="#provider" aria-label="Permalink to &quot;provider&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># Service version</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="consumer" tabindex="-1">consumer <a class="header-anchor" href="#consumer" aria-label="Permalink to &quot;consumer&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># Dubbo Config properties</span></span>
...
<span class="line"><span>      defaultZone: http://\${eureka.instance.hostname}:\${server.port}/eureka/ # 监控页面</span></span></code></pre></div><p>在启动类上添加注解：@EnableEurekaServer，启动后访问<a href="http://localhost:8001/%E5%8D%B3%E5%8F%AF%E3%80%82" target="_blank" rel="noreferrer">http://localhost:8001/即可。</a></p><h4 id="添加客户端" tabindex="-1">添加客户端 <a class="header-anchor" href="#添加客户端" aria-label="Permalink to &quot;添加客户端&quot;">​</a></h4><p>新建模块 client-eureka</p><h4 id="依赖和配置-2" tabindex="-1">依赖和配置 <a class="header-anchor" href="#依赖和配置-2" aria-label="Permalink to &quot;依赖和配置&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>        &lt;dependency&gt;</span></span>
...
<span class="line"><span>      defaultZone: http://localhost:8001/eureka</span></span></code></pre></div><p>启动类添加注解@EnableEurekaClient即可，</p><blockquote><p>@EnableDiscoveryClient和@EnableEurekaClient共同点就是：都是能够让注册中心能够发现，扫描到改服务。</p></blockquote><blockquote><p>不同点：@EnableEurekaClient只适用于Eureka作为注册中心，@EnableDiscoveryClient 可以是其他注册中心。</p></blockquote><p>再次访问</p><blockquote><p>Application AMIs Availability Zones Status EUREKA-CLIENT n/a (1) (1) UP (1) - NoteBook:eureka-client:8002</p></blockquote><h4 id="搭建eureka注册中心集群" tabindex="-1">搭建Eureka注册中心集群 <a class="header-anchor" href="#搭建eureka注册中心集群" aria-label="Permalink to &quot;搭建Eureka注册中心集群&quot;">​</a></h4><blockquote><p>由于所有服务都会注册到注册中心去，服务之间的调用都是通过从注册中心获取的服务列表来调用，注册中心一旦宕机，所有服务调用都会出现问题。所以我们需要多个注册中心组成集群来提供服务，下面将搭建一个双节点的注册中心集群。</p></blockquote><h5 id="搭建两个注册中心" tabindex="-1">搭建两个注册中心 <a class="header-anchor" href="#搭建两个注册中心" aria-label="Permalink to &quot;搭建两个注册中心&quot;">​</a></h5><p>首先给server-eureka添加两个配置文件 application-replica1.yml和application-replica2.yml</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>server:</span></span>
<span class="line"><span>  port: 8002</span></span>
<span class="line"><span>spring:</span></span>
<span class="line"><span>  application:</span></span>
...
<span class="line"><span>    enable-self-preservation: false #关闭eureka服务端的保护机制</span></span></code></pre></div><h4 id="添加认证" tabindex="-1">添加认证 <a class="header-anchor" href="#添加认证" aria-label="Permalink to &quot;添加认证&quot;">​</a></h4><p>需要spring security</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>        &lt;dependency&gt;</span></span>
<span class="line"><span>            &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;</span></span>
...
<span class="line"><span>      password: 123456</span></span></code></pre></div><p>WebConfig</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@EnableWebSecurity</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>对Client而言需要配置中添加用户名密码信息</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span> http://\${username}:\${password}@\${hostname}:\${port}/eureka/</span></span></code></pre></div><h3 id="ribbon" tabindex="-1">Ribbon <a class="header-anchor" href="#ribbon" aria-label="Permalink to &quot;Ribbon&quot;">​</a></h3><p>在微服务架构中，很多服务都会部署多个，其他服务去调用该服务的时候，如何保证负载均衡是个不得不去考虑的问题。负载均衡可以增加系统的可用性和扩展性，当我们使用RestTemplate来调用其他服务时，Ribbon可以很方便的实现负载均衡功能。</p><h4 id="resttemplate" tabindex="-1">RestTemplate <a class="header-anchor" href="#resttemplate" aria-label="Permalink to &quot;RestTemplate&quot;">​</a></h4><blockquote><p>RestTemplate是一个HTTP客户端，使用它我们可以方便的调用HTTP接口，支持GET、POST、PUT、DELETE等方法。</p></blockquote><p>在前面的文章中也有RestTemplate的介绍，注入该实例就可以通过HTTP协议完成远程Restful接口调用。</p><h4 id="user-service" tabindex="-1">User-Service <a class="header-anchor" href="#user-service" aria-label="Permalink to &quot;User-Service&quot;">​</a></h4><p>已有接口如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Resource</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div><p>在没有引入ribbon的时候只需要注入RestTemplate便可以完成远程接口调用。 并且注册服务到Eureka-Server中</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>spring:</span></span>
...
<span class="line"><span>    service-url:</span></span>
<span class="line"><span>      # 配置注册中心地址</span></span>
<span class="line"><span>      defaultZone: http://root:123456@localhost:8005/eureka</span></span></code></pre></div><h4 id="user-ribbon-service" tabindex="-1">User-Ribbon-Service <a class="header-anchor" href="#user-ribbon-service" aria-label="Permalink to &quot;User-Ribbon-Service&quot;">​</a></h4><h4 id="依赖和配置-3" tabindex="-1">依赖和配置 <a class="header-anchor" href="#依赖和配置-3" aria-label="Permalink to &quot;依赖和配置&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>        &lt;dependency&gt;</span></span>
<span class="line"><span>            &lt;groupId&gt;org.springframework.cloud&lt;/groupId&gt;</span></span>
...
<span class="line"><span>    service-url:</span></span>
<span class="line"><span>      # 配置注册中心地址</span></span>
<span class="line"><span>      defaultZone: http://root:123456@localhost:8005/eureka</span></span></code></pre></div><p>对RestTemplate配置：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Bean</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div><p>测试</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Autowired</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div><h4 id="ribbon常用配置" tabindex="-1">Ribbon常用配置 <a class="header-anchor" href="#ribbon常用配置" aria-label="Permalink to &quot;Ribbon常用配置&quot;">​</a></h4><h5 id="全局配置" tabindex="-1">全局配置 <a class="header-anchor" href="#全局配置" aria-label="Permalink to &quot;全局配置&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ribbon:</span></span>
...
<span class="line"><span>  NFLoadBalancerRuleClassName: com.netflix.loadbalancer.RandomRule #修改负载均衡算法</span></span></code></pre></div><h5 id="指定服务进行配置" tabindex="-1">指定服务进行配置 <a class="header-anchor" href="#指定服务进行配置" aria-label="Permalink to &quot;指定服务进行配置&quot;">​</a></h5><blockquote><p>调用user-service的单独配置,至于这个怎么使用,会在后面.</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>user-service:</span></span>
<span class="line"><span>  ribbon:</span></span>
<span class="line"><span>    ConnectTimeout: 1000 #服务请求连接超时时间（毫秒）</span></span>
<span class="line"><span>    ReadTimeout: 3000 #服务请求处理超时时间（毫秒）</span></span>
<span class="line"><span>    OkToRetryOnAllOperations: true #对超时请求启用重试机制</span></span>
<span class="line"><span>    MaxAutoRetriesNextServer: 1 #切换重试实例的最大个数</span></span>
<span class="line"><span>    MaxAutoRetries: 1 # 切换实例后重试最大次数</span></span>
<span class="line"><span>    NFLoadBalancerRuleClassName: com.netflix.loadbalancer.RandomRule #修改负载均衡算法</span></span></code></pre></div><h3 id="feign" tabindex="-1">Feign <a class="header-anchor" href="#feign" aria-label="Permalink to &quot;Feign&quot;">​</a></h3><p>Feign可以理解为社区版的Ribbon和Hystrix的集合，它简化了使用Ribbon所需要的RestTemplate的操作， 更符合基于接口的开发模式，通过内部进一步的封装，可以通过注解的方式完成Rest接口调用和负载均衡的功能， 同时它也提供了基于Hystrix的服务容错保护功能</p><h4 id="依赖和配置-4" tabindex="-1">依赖和配置 <a class="header-anchor" href="#依赖和配置-4" aria-label="Permalink to &quot;依赖和配置&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>        &lt;dependency&gt;</span></span>
<span class="line"><span>            &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;</span></span>
<span class="line"><span>            &lt;artifactId&gt;spring-boot-starter-web&lt;/artifactId&gt;</span></span>
<span class="line"><span>        &lt;/dependency&gt;</span></span>
<span class="line"><span>        &lt;dependency&gt;</span></span>
...
<span class="line"><span>        &lt;/dependency&gt;</span></span></code></pre></div><p>配置基本不变，核心还是注册EurekaCilent</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>server:</span></span>
...
<span class="line"><span>    fetch-registry: true</span></span>
<span class="line"><span>    service-url:</span></span>
<span class="line"><span>      defaultZone: http://root:123456@localhost:8005/eureka</span></span></code></pre></div><h4 id="feignclient" tabindex="-1">FeignClient <a class="header-anchor" href="#feignclient" aria-label="Permalink to &quot;FeignClient&quot;">​</a></h4><p>需要声明一个接口FeignClientService</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@FeignClient(value = &quot;USER-SERVICE&quot;)</span></span>
...
<span class="line"><span>        };</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="常见配置" tabindex="-1">常见配置 <a class="header-anchor" href="#常见配置" aria-label="Permalink to &quot;常见配置&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>#feign接口开启hystrix</span></span>
...
<span class="line"><span>    fetch-registry: true</span></span>
<span class="line"><span>    service-url:</span></span>
<span class="line"><span>      defaultZone: http://root:123456@localhost:8005/eureka</span></span></code></pre></div><p>开启8005端口的Eureka Server和8010端口的服务提供者User-Service, 后者提供Restful接口</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @GetMapping(&quot;/{id}&quot;)</span></span>
<span class="line"><span>    public User userOne(@PathVariable Long id ){</span></span>
<span class="line"><span>        return userService.getById(id);</span></span>
<span class="line"><span>    }</span></span></code></pre></div><p>在hystrix-service启动类上添加注解: @EnableCircuitBreaker用来表示开启熔断器</p><h5 id="hystrixcommand" tabindex="-1">HystrixCommand <a class="header-anchor" href="#hystrixcommand" aria-label="Permalink to &quot;HystrixCommand&quot;">​</a></h5><p>在注册完RestTemplate的基础上,添加接口:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @GetMapping(&quot;/hystrix/user/{id}&quot;)</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>        return new User();</span></span>
<span class="line"><span>    }</span></span></code></pre></div><h5 id="请求缓存" tabindex="-1">请求缓存 <a class="header-anchor" href="#请求缓存" aria-label="Permalink to &quot;请求缓存&quot;">​</a></h5><p>Hystrix有两种方式来应对高并发场景，分别是请求缓存与请求合并 前者鉴于其缺点:</p><ul><li>是一个本地缓存。在集群情况下缓存是不能同步的。</li><li>不支持第三方缓存容器。Redis，memcache 不支持的。 所以往往使用SpringCache来替代.</li></ul><blockquote><p>@CacheResult：开启缓存，默认所有参数作为缓存的key，cacheKeyMethod可以通过返回String类型的方法指定key； @CacheKey：指定缓存的key，可以指定参数或指定参数中的属性值为缓存key，cacheKeyMethod还可以通过返回String类型的方法指定； @CacheRemove：移除缓存，需要指定commandKey。</p></blockquote><p>在缓存使用过程中，我们需要在每次使用缓存的请求前后对HystrixRequestContext进行初始化和关闭,否则会报异常:</p><blockquote><p>Request caching is not available. Maybe you need to initialize the HystrixRequestContext?</p></blockquote><p>所以需要声明一个Filter,在doFilter中开启和关闭HystrixRequestContext</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@Component</span></span>
...
<span class="line"><span>        include: &#39;hystrix.stream&#39;</span></span></code></pre></div><p>被检控方需要注册一个servlet bean</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Bean</span></span>
...
<span class="line"><span>        &lt;/dependency&gt;</span></span></code></pre></div><h4 id="yml" tabindex="-1">yml <a class="header-anchor" href="#yml" aria-label="Permalink to &quot;yml&quot;">​</a></h4><p>Gateway的基本功能仅用配置即可完成</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>spring:</span></span>
<span class="line"><span>  application:</span></span>
...
<span class="line"><span>    gateway:</span></span>
<span class="line"><span>      enabled: true</span></span></code></pre></div><h4 id="配合jwt实现鉴权的demo" tabindex="-1">配合JWT实现鉴权的demo <a class="header-anchor" href="#配合jwt实现鉴权的demo" aria-label="Permalink to &quot;配合JWT实现鉴权的demo&quot;">​</a></h4><p>配置全局过滤器,对请求进行过滤,检测token是否有效.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package com.zong.filter;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>    }</span></span></code></pre></div><p>在用户微服务login接口中生成jwt token</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span> User user = userService.findById(name);</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">dependency</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h4 id="客户端配置" tabindex="-1">客户端配置 <a class="header-anchor" href="#客户端配置" aria-label="Permalink to &quot;客户端配置&quot;">​</a></h4><p>删除客户端原配置文件,新增bootstrap.yml引导文件</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">spring</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  cloud</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    config</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">dependency</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h4 id="服务端配置-1" tabindex="-1">服务端配置 <a class="header-anchor" href="#服务端配置-1" aria-label="Permalink to &quot;服务端配置&quot;">​</a></h4><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">server</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  port</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">6001</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">eureka</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  instance</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    prefer-ip-adress</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">true</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    &lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">dependency</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">dependencies</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h4 id="客户端配置-1" tabindex="-1">客户端配置 <a class="header-anchor" href="#客户端配置-1" aria-label="Permalink to &quot;客户端配置&quot;">​</a></h4><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">spring</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  cloud</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    config</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        &lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">dependencies</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    &lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">dependencyManagement</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">project</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h5 id="客户端配置-2" tabindex="-1">客户端配置 <a class="header-anchor" href="#客户端配置-2" aria-label="Permalink to &quot;客户端配置&quot;">​</a></h5><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Spring</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">spring</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  application</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">dependency</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h4 id="客户端配置-3" tabindex="-1">客户端配置 <a class="header-anchor" href="#客户端配置-3" aria-label="Permalink to &quot;客户端配置&quot;">​</a></h4><ol><li>删除旧的application.yml,新增bootstrap.yml</li><li>添加配置</li></ol><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">spring</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  application</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">provider</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  cloud</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    nacos</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    active</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">dev</span></span></code></pre></div><p>在上面的配置中，配置了nacos config server的地址，配置的扩展名是ymal（目前仅支持ymal和properties）。注意是没有配置server.port的，sever.port的属性在nacos中配置。上面的配置是和Nacos中的<code>dataId</code> 的格式是对应的，nacos的完整格式如下：</p><blockquote><p><img src="https://g.yuque.com/gr/latex?-#card=math&amp;code=-#crop=0&amp;crop=0&amp;crop=1&amp;crop=1&amp;id=e7J4B&amp;originHeight=20&amp;originWidth=16&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;status=done&amp;style=none&amp;title=" alt="">.$</p></blockquote><ol><li>启动nacos，登陆localhost:8848/nacos，创建一个data id:provider-dev.yaml,发布后启动客户端.</li></ol><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">server</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  port</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">8081</span></span></code></pre></div><ol><li>动态刷新(与Cloud Bus不同)</li></ol><p>需要@RefreshScope注解,修改nacos中的provider-dev.yaml后重新访问下接口,即可实现</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> org.springframework.beans.factory.annotation.Value;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h4 id="服务端配置持久化" tabindex="-1">服务端配置持久化 <a class="header-anchor" href="#服务端配置持久化" aria-label="Permalink to &quot;服务端配置持久化&quot;">​</a></h4><p>在单机模式时<code>nacos</code>使用嵌入式数据库实现数据的存储，不方便观察数据存储的基本情况。我们可以配置<code>mysql</code>数据库，可视化的查看数据的存储。</p><ul><li>在nacos的 &#39;\\nacos\\conf&#39; 目录下,存在nacos-mysql.sql文件,导入数据库后</li><li>进入 config文件夹下的 application.properties文件，增加</li></ul><div class="language-properties vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">properties</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># db mysql</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">db.password</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=123123</span></span></code></pre></div><ul><li>单机启动nacos添加配置后即可看到nacos的配置.</li></ul><h3 id="客户端整合ribbon-openfeign" tabindex="-1">客户端整合Ribbon/OpenFeign <a class="header-anchor" href="#客户端整合ribbon-openfeign" aria-label="Permalink to &quot;客户端整合Ribbon/OpenFeign&quot;">​</a></h3><h4 id="ribbon-1" tabindex="-1">Ribbon <a class="header-anchor" href="#ribbon-1" aria-label="Permalink to &quot;Ribbon&quot;">​</a></h4><p>依赖和配置</p><p>不需要额外的依赖,只需要注册一个bean</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 新增restTemplate对象注入方法，注意，此处LoadBalanced注解一定要加上，否则无法远程调用</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h4 id="controller" tabindex="-1">Controller <a class="header-anchor" href="#controller" aria-label="Permalink to &quot;Controller&quot;">​</a></h4><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    enabled</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">true</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> # 开启hystrix</span></span></code></pre></div><p>启动类添加Feign客户端注解:<a href="/EnableFeignClients.html">@EnableFeignClients </a></p><h5 id="测试-2" tabindex="-1">测试 <a class="header-anchor" href="#测试-2" aria-label="Permalink to &quot;测试&quot;">​</a></h5><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> com.zong.service.impl.TestServiceImpl;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h5 id="请求拦截器" tabindex="-1">请求拦截器 <a class="header-anchor" href="#请求拦截器" aria-label="Permalink to &quot;请求拦截器&quot;">​</a></h5><p>在微服务应用中，通过<code>feign</code>的方式实现<code>http</code>的调用，可以通过实现<code>feign.RequestInterceptor</code>接口在<code>feign</code>执行后进行拦截，对请求头等信息进行修改。</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">package</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> com.zong.config;</span></span>
<span class="line"></span>
