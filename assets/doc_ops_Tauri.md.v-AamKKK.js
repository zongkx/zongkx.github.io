import{_ as s,c as n,o as t,ag as p}from"./chunks/framework.Bw-5EFTY.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"doc/ops/Tauri.md","filePath":"doc/ops/Tauri.md"}'),e={name:"doc/ops/Tauri.md"};function r(o,a,i,l,c,u){return t(),n("div",null,a[0]||(a[0]=[p(`<h2 id="rust离线安装" tabindex="-1">Rust离线安装 <a class="header-anchor" href="#rust离线安装" aria-label="Permalink to &quot;Rust离线安装&quot;">​</a></h2><p><a href="https://static.rust-lang.org/dist/rust-1.80.1-i686-pc-windows-gnu.msi" target="_blank" rel="noreferrer">下载链接</a> 一直点下一步即可</p><h2 id="cargo-代理" tabindex="-1">cargo 代理 <a class="header-anchor" href="#cargo-代理" aria-label="Permalink to &quot;cargo 代理&quot;">​</a></h2><p>用户目录 ./cargo 中新建 config.toml</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[source.crates-io]</span></span>
