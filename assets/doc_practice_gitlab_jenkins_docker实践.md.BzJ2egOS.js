import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.JkBXQW4V.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"doc/practice/gitlab_jenkins_docker实践.md","filePath":"doc/practice/gitlab_jenkins_docker实践.md"}'),e={name:"doc/practice/gitlab_jenkins_docker实践.md"},l=p(`<h2 id="gitlab-jenkins-docker-docker" tabindex="-1">gitlab+jenkins+docker+docker <a class="header-anchor" href="#gitlab-jenkins-docker-docker" aria-label="Permalink to &quot;gitlab+jenkins+docker+docker&quot;">​</a></h2><p>目前公司运行了一套上述服务部署环境,作为一名后端开发虽然没有亲自部署过这些服务,但是简单使用还是很有必要掌握的.</p><h3 id="_1-gitlab" tabindex="-1">1. gitlab <a class="header-anchor" href="#_1-gitlab" aria-label="Permalink to &quot;1. gitlab&quot;">​</a></h3><p>gitlab中一般包括dev/master分支,分别用于测试环境和生产环境</p><h3 id="_2-项目中的配置" tabindex="-1">2. 项目中的配置 <a class="header-anchor" href="#_2-项目中的配置" aria-label="Permalink to &quot;2. 项目中的配置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>  &lt;profiles&gt;</span></span>
...
<span class="line"><span>        &lt;/resources&gt;</span></span>
<span class="line"><span>    &lt;/configuration&gt;</span></span>
<span class="line"><span>&lt;/plugin&gt;</span></span></code></pre></div><p><code>deploy.yml</code>:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>apiVersion: extensions/v1beta1</span></span>
...
<span class="line"><span>          name: mydemo-service</span></span>
<span class="line"><span>      restartPolicy: Always</span></span></code></pre></div><p><code>svc.yml</code></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>apiVersion: v1</span></span>
...
<span class="line"><span>  type: NodePort</span></span></code></pre></div><p><code>dockerfile</code></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>FROM openjdk:8-arthas</span></span>
...
<span class="line"><span>   }</span></span>
<span class="line"><span>}</span></span></code></pre></div><ol><li>拉代码</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>  stage(&#39;获取代码&#39;) {</span></span>
...
<span class="line"><span>   }</span></span></code></pre></div><ol start="2"><li>构建并推送镜像</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>  stage(&#39;maven build &amp;&amp; deploy &#39;) {      </span></span>
...
<span class="line"><span>   }</span></span></code></pre></div><p>依赖插件<code>docker-maven-plugin</code></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span> &lt;plugin&gt;</span></span>
...
<span class="line"><span>        &lt;/resources&gt;</span></span>
<span class="line"><span>    &lt;/configuration&gt;</span></span>
<span class="line"><span>&lt;/plugin&gt;</span></span></code></pre></div><ol start="3"><li>k8s部署</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>   sh  &quot;cd mydemo-service &amp;&amp; kubectl  -s http://127.0.0.1:8888 apply  -f  target/classes/deploy.yaml -f target/classes/svc.yaml&quot;</span></span></code></pre></div><h3 id="_4-k8s" tabindex="-1">4. k8s <a class="header-anchor" href="#_4-k8s" aria-label="Permalink to &quot;4. k8s&quot;">​</a></h3><p>在k8s中指定的命名空间即可找到对应服务.</p>`,27),t=[l];function i(c,o,r,g,d,u){return n(),a("div",null,t)}const v=s(e,[["render",i]]);export{h as __pageData,v as default};
