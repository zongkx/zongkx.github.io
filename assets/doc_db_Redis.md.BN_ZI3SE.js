...
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="测试" tabindex="-1">测试 <a class="header-anchor" href="#测试" aria-label="Permalink to &quot;测试&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Resource</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div><h3 id="拦截器和配置" tabindex="-1">拦截器和配置 <a class="header-anchor" href="#拦截器和配置" aria-label="Permalink to &quot;拦截器和配置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Resource</span></span>
...
<span class="line"><span>        return true;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="接口和测试" tabindex="-1">接口和测试 <a class="header-anchor" href="#接口和测试" aria-label="Permalink to &quot;接口和测试&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Resource</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div><blockquote><p><a href="http://localhost:8080/login?username=test&amp;password=123" target="_blank" rel="noreferrer">http://localhost:8080/login?username=test&amp;password=123</a> 用户：test登录成功，token是：564aa232-a015-481e-94f3-8a0174b11932</p></blockquote><blockquote><p>GET /test HTTP/1.1 token: 564aa232-a015-481e-94f3-8a0174b11932 Host: localhost:8080 ok</p></blockquote><blockquote><p>GET /logout HTTP/1.1 token: 564aa232-a015-481e-94f3-8a0174b11932 Host: localhost:8080 注销成功</p></blockquote><h3 id="拓展" tabindex="-1">拓展 <a class="header-anchor" href="#拓展" aria-label="Permalink to &quot;拓展&quot;">​</a></h3><ul><li>基于Token可以实现简单的单点登录,将token放到cookie中</li><li>redis的value可以适当存储用户的信息</li><li>token的生成规则可以适当复杂</li><li>拦截器可以自定义拦截特定的token</li><li>jwt扩展,后续会用.</li></ul><h1 id="redission" tabindex="-1">Redission <a class="header-anchor" href="#redission" aria-label="Permalink to &quot;Redission&quot;">​</a></h1><h2 id="分布式存在的并发问题" tabindex="-1">分布式存在的并发问题 <a class="header-anchor" href="#分布式存在的并发问题" aria-label="Permalink to &quot;分布式存在的并发问题&quot;">​</a></h2><h2 id="问题模拟" tabindex="-1">问题模拟 <a class="header-anchor" href="#问题模拟" aria-label="Permalink to &quot;问题模拟&quot;">​</a></h2><p>商品购买,在单机时并发问题可以通过synchronized, 但是在分布式情况下,JVM级别的锁不会生效.</p><p>假设: redis存了个string [stock:200]</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@GetMapping(&quot;/buy&quot;)</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><ol><li>启动两个服务product 8081/8082,并使用Nginx做负载均衡</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span> # 待选服务器列表</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><ol><li>使用jmeter进行压力测试</li></ol><blockquote><p><a href="http://127.0.0.1/buy" target="_blank" rel="noreferrer">http://127.0.0.1/buy</a></p></blockquote><p>可以看到后台打印的剩余库存出现了同样的数字.</p><h2 id="解决" tabindex="-1">解决 <a class="header-anchor" href="#解决" aria-label="Permalink to &quot;解决&quot;">​</a></h2><h3 id="入门级-setnx-set-if-not-exists" tabindex="-1">入门级 setnx (set if not exists) <a class="header-anchor" href="#入门级-setnx-set-if-not-exists" aria-label="Permalink to &quot;入门级 setnx (set if not exists)&quot;">​</a></h3><p>setnx key value 将key的值设为value,当且仅当key不存在</p><p>利用redis单线程模型,若干线程同时执行setnx,会进入队列.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @GetMapping(&quot;/buy2&quot;)</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>        return &quot;buy end&quot;;</span></span>
<span class="line"><span>    }</span></span></code></pre></div><p>高并发仍然存在的问题: 锁永久失效:假设线程1try后面的代码执行时间超过了锁的过期时间,此时线程2进入并加锁,但线程1会执行到释放锁的地方, 导致线程1删除了线程2的锁.</p><h3 id="优化-添加锁需要原子操作-每个线程加的锁的value都设为uuid-释放锁的时候进行判断" tabindex="-1">优化:(添加锁需要原子操作)每个线程加的锁的value都设为UUID,释放锁的时候进行判断 <a class="header-anchor" href="#优化-添加锁需要原子操作-每个线程加的锁的value都设为uuid-释放锁的时候进行判断" aria-label="Permalink to &quot;优化:(添加锁需要原子操作)每个线程加的锁的value都设为UUID,释放锁的时候进行判断&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    String id  = UUID.randomUUID().toString();</span></span>
<span class="line"><span>    // setIfAbsent原子命令</span></span>
...
<span class="line"><span>    &lt;/dependency&gt;</span></span></code></pre></div><h4 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Bean</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>    }</span></span></code></pre></div><h4 id="加锁和释放" tabindex="-1">加锁和释放 <a class="header-anchor" href="#加锁和释放" aria-label="Permalink to &quot;加锁和释放&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Autowired</span></span>
