import{_ as s,c as a,o as n,a4 as e}from"./chunks/framework.4aTu-Nia.js";const x=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"doc/ops/Nginx.md","filePath":"doc/ops/Nginx.md"}'),p={name:"doc/ops/Nginx.md"},i=e(`<h2 id="https" tabindex="-1">https <a class="header-anchor" href="#https" aria-label="Permalink to &quot;https&quot;">​</a></h2><ul><li>阿里云申请的ssl证书包括 <code>zkx.com_public.crt</code>,<code>zkx.com_chain.crt</code>,<code>zkx.com.key</code>,使用1/3即可</li><li>dockerfile 需要把前端的镜像里面添加 上面的证书文件</li></ul><div class="language-Dockerfile vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">Dockerfile</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">FROM</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> nginx:1.24.0</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">COPY</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> nginx/conf/default.conf /etc/nginx/conf.d/default.conf</span></span></code></pre></div><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>server {</span></span>
...
<span class="line"><span>        proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,4),l=[i];function t(c,o,r,d,h,_){return n(),a("div",null,l)}const m=s(p,[["render",t]]);export{x as __pageData,m as default};
