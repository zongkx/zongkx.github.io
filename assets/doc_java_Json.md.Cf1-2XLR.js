import{_ as s,c as a,o as n,a3 as e}from"./chunks/framework.COm4hYgr.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"doc/java/Json.md","filePath":"doc/java/Json.md"}'),p={name:"doc/java/Json.md"},t=e(`<h2 id="jsonlines" tabindex="-1">jsonlines <a class="header-anchor" href="#jsonlines" aria-label="Permalink to &quot;jsonlines&quot;">​</a></h2><p><a href="https://jsonlines.org/examples/" target="_blank" rel="noreferrer">https://jsonlines.org/examples/</a> 简化表格数据</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>        List&lt;String&gt; resp = Arrays.asList(&quot;aaa&quot;);</span></span>
...
<span class="line"><span>            });</span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>        InputStream inputStream = new ByteArrayInputStream(byteArrayOutputStream.toByteArray());</span></span></code></pre></div><h2 id="json-patch" tabindex="-1">json patch <a class="header-anchor" href="#json-patch" aria-label="Permalink to &quot;json patch&quot;">​</a></h2><p>可以对json中的指定内容进行 crud操作</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>        &lt;dependency&gt;</span></span>
...
<span class="line"><span>        &lt;/dependency&gt;</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>   public static class PagePatch {</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>        PagePatch pagePatch = new PagePatch(&quot;replace&quot;, &quot;/pageNum&quot;, 2);</span></span>
...
<span class="line"><span>        JsonNode apply = patch.apply(objectMapper.readTree(body));// 将body: {&quot;pageNum&quot;:&quot;1&quot;,&quot;size&quot;:&quot;100&quot;}中的pageNum修改为2 ,apply结果为 {&quot;pageNum&quot;:&quot;2&quot;,&quot;size&quot;:&quot;100&quot;}</span></span></code></pre></div><h2 id="json-schema" tabindex="-1">json schema <a class="header-anchor" href="#json-schema" aria-label="Permalink to &quot;json schema&quot;">​</a></h2><p>json描述性信息,可以用来校验json</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>        &lt;dependency&gt;</span></span>
...
<span class="line"><span>        &lt;/dependency&gt;</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    @Test</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>public class JsonSchemaUtil {</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="jmespath" tabindex="-1">JMESPath <a class="header-anchor" href="#jmespath" aria-label="Permalink to &quot;JMESPath&quot;">​</a></h2><p>通过jmespath可以轻松的获取json中的指定内容 <a href="https://jmespath.org/" target="_blank" rel="noreferrer">https://jmespath.org/</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>        &lt;dependency&gt;</span></span>
...
<span class="line"><span>        &lt;/dependency&gt;</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>                    JmesPath&lt;JsonNode&gt; jmespath = new JacksonRuntime();</span></span>
<span class="line"><span>                    Expression&lt;JsonNode&gt; expression = jmespath.compile(&quot;data.totalPage&quot;);</span></span>
<span class="line"><span>                    JsonNode res = expression.search(objectMapper.readTree(&quot;{\\&quot;data\\&quot;:{\\&quot;totalPage\\&quot;:10}}&quot;));</span></span></code></pre></div>`,17),o=[t];function l(i,c,r,u,d,h){return n(),a("div",null,o)}const m=s(p,[["render",l]]);export{q as __pageData,m as default};
