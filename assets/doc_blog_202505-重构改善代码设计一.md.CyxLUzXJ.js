import{_ as n,c as s,o as p,ag as l}from"./chunks/framework.Bw-5EFTY.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"doc/blog/202505-重构改善代码设计一.md","filePath":"doc/blog/202505-重构改善代码设计一.md"}'),e={name:"doc/blog/202505-重构改善代码设计一.md"};function i(t,a,c,o,r,d){return p(),s("div",null,a[0]||(a[0]=[l(`<h2 id="提炼函数" tabindex="-1">提炼函数 <a class="header-anchor" href="#提炼函数" aria-label="Permalink to &quot;提炼函数&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 重构前</span></span>
