import{c as a,Q as n,j as p,m as e}from"./chunks/framework.CQedrDFh.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"doc/ops/Jmeter&K6.md","filePath":"doc/ops/Jmeter&K6.md"}'),t={name:"doc/ops/Jmeter&K6.md"};function l(i,s,o,r,c,m){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h2 id="jmeter" tabindex="-1">Jmeter <a class="header-anchor" href="#jmeter" aria-label="Permalink to &quot;Jmeter&quot;">​</a></h2><h3 id="单个请求" tabindex="-1">单个请求 <a class="header-anchor" href="#单个请求" aria-label="Permalink to &quot;单个请求&quot;">​</a></h3><ol><li><p>添加线程组G1,设置线程数10,ramp-up 1,循环1</p></li><li><p>添加一个Http Header Manager,设置共享header</p></li><li><p>线程组下添加十个HTTP请求</p><blockquote><p>http请求下可添加BeanShell 后置处理器,防止乱码./添加固定定时器,设置间隔 prev.setDataEncoding(&quot;UTF-8&quot;);</p></blockquote></li><li><p>添加查看结果树和聚合报告</p></li></ol><h3 id="多个请求" tabindex="-1">多个请求 <a class="header-anchor" href="#多个请求" aria-label="Permalink to &quot;多个请求&quot;">​</a></h3><ol><li>添加线程组G1-G10,设置线程数1,ramp-up 1,循环1</li><li>每个线程组添加一个HTTP请求,并设置不同的body json</li><li>添加查看结果树和聚合报告</li></ol><h2 id="k6" tabindex="-1">K6 <a class="header-anchor" href="#k6" aria-label="Permalink to &quot;K6&quot;">​</a></h2><p>相较于jmeter,更加轻量,需要编写js代码完成测试</p><blockquote><p><a href="https://k6.io/docs/" target="_blank" rel="noreferrer">https://k6.io/docs/</a></p></blockquote><p>win安装</p><blockquote><p><a href="https://dl.k6.io/msi/k6-latest-amd64.msi" target="_blank" rel="noreferrer">https://dl.k6.io/msi/k6-latest-amd64.msi</a></p></blockquote><p>idea 插件安装</p><blockquote><p><a href="https://plugins.jetbrains.com/plugin/16141-k6" target="_blank" rel="noreferrer">https://plugins.jetbrains.com/plugin/16141-k6</a></p></blockquote><h3 id="简单测试" tabindex="-1">简单测试 <a class="header-anchor" href="#简单测试" aria-label="Permalink to &quot;简单测试&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import http from &#39;k6/http&#39;;</span></span>
